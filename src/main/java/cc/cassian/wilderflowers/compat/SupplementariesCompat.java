...
public class SupplementariesCompat {
    public static void register() {
        //? if <1.21.2 {
        /*FlowerPotHandler.CUSTOM_MODELS.add(WilderFlowers.locate("block/cheery_wildflowers_potted"));
        FlowerPotHandler.registerCustomSimpleFlower(WilderFlowersBlocks.CHEERY_WILDFLOWERS.flowerBedItem(), WilderFlowers.locate("block/cheery_wildflowers_potted"));
